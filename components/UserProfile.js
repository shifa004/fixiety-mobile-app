...
import { AntDesign, Entypo, Fontisto, Feather, FontAwesome5 } from 'react-native-vector-icons'
import { ref, uploadBytesResumable, getDownloadURL } from 'firebase/storage'
import * as ImagePicker from 'expo-image-picker';
import { doc, setDoc, getDocs, getDoc,collection,updateDoc, Timestamp, query, where } from "firebase/firestore";
    ...
    return (
        <KeyboardAvoidingView style={styles.container} behavior={Platform.OS == 'ios' ? "padding" : "height"} keyboardVerticalOffset={Platform.OS == 'ios' ? 150 : -200} >
            ...
            <TouchableOpacity onPress={pickImage} style={styles.header}>
                    {picture != null ? <Image source={{ uri: picture }} style={styles.image} />: <Avatar source={require('../assets/profile.png')} size={screenWidth * 0.33} rounded /> }
                    <Text style={{color:'grey', marginTop:screenWidth*0.03}}>Click on the image to change</Text>
                </TouchableOpacity>
                ...
                <View style={styles.fields}>
                    ...
                    <Text style={{marginTop:screenWidth *0.04, marginLeft:screenWidth*0.05}}>{username}</Text>
                </View>
                ...
                <View style={styles.fields}>
                    ...
                    <TextInput value={fname} style={styles.input} onChangeText={(text) => setFname(text)}></TextInput>
                </View>

                <View style={styles.fields}>
                    <View style={{ marginTop: screenWidth * 0.04, marginRight: screenWidth * 0.01 }}>
